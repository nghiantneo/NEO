...
;(function (factory) {
    ...
    var _options = {
        input: null,
        minLength: 10,           // Modified feature, now accepts 0 to search on focus
        maxItem: 10,             // Modified feature, now accepts 0 as "Infinity" meaning all the results will be displayed
        dynamic: false,
        delay: 100,
