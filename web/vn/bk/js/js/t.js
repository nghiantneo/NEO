...
$(function () {
	...
	var path = "";
	//alert(window.location.pathname.indexOf("mediaplayOne"));
	if ( window.location.pathname.indexOf("mediaplayOne")>=1)
	{
		//request.getParameter("isPlayOne")
		path = "audios/Xa Mot Cuoc Tinh - Anh Khang.mp3";
	}
	else
		path = '/web/media/vn/funring/pl.xml';
...
function eventStartSongImuzik() {//alert("6666666");
    if (isAllowClick()) {
...
//Player.Ready
function playerReady(thePlayer) {//alert("7777777777");
...
function imuzikLoadPlayer() {//alert("88888888");
...
function callbackFn(e) {//alert("9999999");
//    alert(e.success);
...
function playOneSongAllowed(playIndex) {//alert("000000000000");
    var listsSong = player.getPlaylist();
    var maxLength = listsSong.length;
    var canPlay = 0;
