	...
	var imgDir = '/web/vn/loyalty/images/site/';		// directory for images ... e.g. var imgDir="/img/"
	var dayName = '';
	var fulldayName = '';
	var gotoString = {
	...
	var scrollLeftMessage = {
		...
		vi : 'Click d? ch?n tháng tru?c. Gi? chu?t d? tru?t t? d?ng.'
	};
	...
	var	monthName = {
		...
		vi : new Array('Tháng Giêng','Tháng Hai','Tháng Ba','Tháng Tu','Tháng Nam','Tháng Sáu','Tháng B?y','Tháng Tám','Tháng Chín','Tháng Mu?i','Tháng Mu?i M?t','Tháng Mu?i Hai')
	};
	var	monthName2 = {
		...
		vi : new Array('Giêng','Hai','Ba','Tu','Nam','Sáu','B?y','Tám','Chín','Mu?i','Mu?i M?t','Ch?p')
	};
	...
	if (startAt==0) {
		dayName = {
			...
			vi : new Array('CN','Hai','Ba','Tu','Nam','Sáu','B?y')
		};
		fulldayName = new Array	("Ch? Nh?t","Th? Hai","Th? Ba","Th? Tu","Th? Nam","Th? Sáu","Th? B?y")
	} else {
		dayName = {
			en : new Array('Mon','Tue','Wed','Thu','Fri','Sat','Sun'),
			es : new Array('Lun','Mar','Mie','Jue','Vie','Sab','Dom'),
			de : new Array('Mo','Di','Mi','Do','Fr','Sa','So'),
			vi : new Array	('Hai','Ba','Tu','Nam','Sáu','B?y','CN')
		};
		fulldayName = new Array	("Th? Hai","Th? Ba","Th? Tu","Th? Nam","Th? Sáu","Th? B?y", "Ch? Nh?t") 
	}
	...
	*/
	...
	function closeCalendar() {
		...
		if (zone == "-1")
		{
		txtObj.value=constructDate(dateSelected,monthSelected,yearSelected);
		//document.thForm.submit();
		return;
		}
		if (zone == null)
		{
		...
		else
		{
			...
			location.href = str + '.vip?ByDate=' + constructDate(dateSelected,monthSelected,yearSelected);
		}		
//		location.href = 'Zone.aspx?zone=' + zone + '&ByDate=' + constructDate(dateSelected,monthSelected,yearSelected);
	...
	function constructCalendar () {//alert("here6");
	...
	function popUpCalendar(ctl, ctl2, format,zoneid, obj) {//alert("here");
		txtObj = obj;
		var leftpos = 0;
		var toppos  = 0;
		zone = zoneid;
		if (bPageLoaded) {
			if (crossobj.visibility == 'hidden') {//alert("here1");
				...
				crossobj.top = (fixedY == -1) ? ctl.offsetTop + toppos - 140 : fixedY;//alert("here5");
