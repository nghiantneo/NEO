...
a.artist+'</a><div class="icon_view"><span><i class="icon_main"></i>'+a.listen_no+'</span><span><i class="icon_main"></i>'+a.download_no+'</span></div><span name="bxh_listen" >'+a.listen_no+"</span></span></p>"):d+('<div tabindex="0" class="ka-content audio-content '+this.options.playlistOptions.itemClass+'"><a title="'+a.title+'" class="ka-lnk"></a><div class="ka-info"><h3 class="ka-info-h3"><a title="'+a.title+'" class="jp-playlist-item-h3"  href="javascript:;">'+a.title+'</a></h3><p class="ka-info-singer"><a>'+a.artist+
'</a></span></p><div class="icon_view"><span><i class="icon_main"></i>'+a.listen_no+'</span><span><i class="icon_main"></i>'+a.download_no+'</span></div></div></div>');return d+="</div></li>"},_createItemHandlers:function(){var a=this;b(this.cssSelector.playlist).off("click","a."+this.options.playlistOptions.itemClass).on("click","a."+this.options.playlistOptions.itemClass,
